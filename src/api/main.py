"""Password Reset Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Automated password reset agent that verifies user identity through multi-factor challenges, resets passwords across enterprise systems, enforces password policies, and securely communicates new credentials.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
